    ...
    <form action={action} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            type="datetime-local"
            required
            defaultValue={toDateTimeInputValue(initial?.startAt ?? defaultStart)}
            className="input"
          />
        </div>
        <div>
          ...
          <input
            ...
            type="datetime-local"
            required
            defaultValue={toDateTimeInputValue(initial?.endAt ?? defaultEnd)}
            className="input"
          />
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div>
          ...
          <select id="status" name="status" defaultValue={initial?.status ?? "SCHEDULED"} className="input">
